...
function SignUp() {
  ...
  const handleChange = (e) => {
    ...
    let userErrorsUpdate = { ...userErrors };
    console.log(userErrorsUpdate);
    if (value.trim() === "") {
      userErrorsUpdate[name] = name + " không được bỏ trống";
    } else {
      userErrorsUpdate[name] = "";
    }
    // let newUserErrors = {...userErrors,[name]:er rorMessage};
    setUser({
      ...user,
      [name]: value,
    });
    setUserErrors({
      userErrors: userErrorsUpdate,
    });
  };
      ...
      <div className="signup--wrapper">
        ...
        <form onSubmit={handleSubmit} className="text-white text-left">
          <div className="row">
            ...
            <p
              style={{ margin: 0 }}
              className="text-center text-warning col-xl-12"
            >
              {userErrors.taiKhoan}
            </p>
          </div>
          <div className="row">
            ...
            <input
              ...
              onChange={handleChange}
            />
            <p className="text-warning">{userErrors.matKhau}</p>
          </div>
          <div className="row">
            ...
            <input
              ...
              onChange={handleChange}
            />
            <p className="text-warning">{userErrors.hoTen}</p>
          </div>
          <div className="row">
